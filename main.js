...
//btn handle fucntion
function handlesSlideBtnClick(e) {
...
// event listenes
slideBtns.forEach(btn => btn.addEventListener('click', handlesSlideBtnClick));

slideContainer.addEventListener('sliderMove', () => {
    // 1. translate container l r
